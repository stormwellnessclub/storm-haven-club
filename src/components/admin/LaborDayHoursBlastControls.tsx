...
const FN = "send-labor-day-hours-blast";
...
export function LaborDayHoursBlastControls() {
    ...
    <div className="rounded-lg border p-4 space-y-3 bg-card">
      <div>
        <h3 className="font-semibold text-base flex items-center gap-2">
          <Mail className="h-4 w-4" /> Labor Day Hours Update — Monday Sept 7, 9am–4pm
        </h3>
        <p className="text-sm text-muted-foreground mt-1">
          Updated Labor Day hours notice. Open <strong>View recipients</strong> to see exactly who gets it and
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <AlertDialog>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle>Send the Labor Day hours update email?</AlertDialogTitle>
              <AlertDialogDescription>
                {recipients.length
