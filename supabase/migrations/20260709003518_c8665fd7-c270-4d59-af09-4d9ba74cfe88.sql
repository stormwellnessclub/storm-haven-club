...
REVOKE ALL ON FUNCTION public.submit_class_review(uuid, uuid, uuid, integer, text) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.submit_class_review(uuid, uuid, uuid, integer, text) FROM anon;
GRANT EXECUTE ON FUNCTION public.submit_class_review(uuid, uuid, uuid, integer, text) TO authenticated;
