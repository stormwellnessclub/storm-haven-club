...
const TEMPLATE_KEY = "harvest_moon_sep_27_2026_reminder";
const TEST_TEMPLATE_KEY = "harvest_moon_sep_27_2026_reminder_test";
const BASE_URL = "https://stormwellnessclub.com";
const EVENT_URL = `${BASE_URL}/events/under-the-harvest-moon`;
const SUBJECT = "This Sunday: Under the Harvest Moon — 6:00 PM";
  ...
  return `
    <div style="font-family:Georgia,'Times New Roman',Times,serif;max-width:600px;margin:0 auto;padding:0;">
      ...
      <div style="background:#ffffff;padding:34px 30px;border-left:1px solid #C1B19C;border-right:1px solid #C1B19C;color:#1C170F;line-height:1.75;">
        <p style="color:#a17e3a;font-family:Arial,sans-serif;letter-spacing:2.5px;font-size:11px;margin:0 0 10px;">THIS SUNDAY</p>
        ...
        <div style="background:#F7F4EC;border:1px solid #E7DFCF;padding:18px 20px;border-radius:6px;margin:0 0 24px;">
          ...
          <p style="margin:8px 0 0;font-size:14px;color:#88766B;">Included with your membership</p>
        </div>

        <p style="margin:0 0 16px;">${greeting}</p>

        <p style="margin:0 0 16px;">A gentle reminder that our Women's Release &amp; Renewal Circle gathers this Sunday evening at six.</p>
        ...
        <p style="margin:22px 0 0;font-size:13px;color:#88766B;text-align:center;">
          <a href="${EVENT_URL}" style="color:#a17e3a;">View the evening &rarr;</a>
        </p>
      </div>
