...
export default function InfraredSauna() {
  return (
    <ServiceLandingPage
      title="Infrared Sauna in Livonia, MI"
      description="Far-infrared sauna sessions at Storm Wellness Club in Livonia, MI. Deep heat for detox, recovery, cardiovascular health, and stress relief."
      path="/spa/infrared-sauna"
      serviceName="Infrared Sauna"
      h1="Infrared Sauna in Livonia, MI"
      subhead="Deep, penetrating heat that warms your body from the inside — supporting cardiovascular health, detoxification, and post-training recovery."
      body={[
        ...
        "Located inside our circular wellness building in Livonia, the infrared sauna is part of a full recovery circuit alongside cold plunge, red light therapy, cryotherapy, and the salt room.",
      ]}
      benefits={[
