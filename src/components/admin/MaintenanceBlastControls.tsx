...
const FN = "send-july-23-maintenance-blast";

export function MaintenanceBlastControls() {
    ...
    <div className="rounded-lg border p-4 space-y-3 bg-card">
      <div>
        <h3 className="font-semibold text-base flex items-center gap-2">
          <Mail className="h-4 w-4" /> July 23 Maintenance Email Blast
        </h3>
        <p className="text-sm text-muted-foreground mt-1">
          Sends one email per active member (idempotent — re-running skips anyone already sent).
        </p>
      </div>
      <div className="flex flex-wrap gap-2">
        ...
        <AlertDialog>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle>Send July 23 maintenance email?</AlertDialogTitle>
              <AlertDialogDescription>
      ...
      <Dialog open={previewOpen} onOpenChange={setPreviewOpen}>
        <DialogContent className="max-w-3xl h-[85vh] flex flex-col p-0">
          <DialogHeader className="p-4 border-b">
            <DialogTitle>Email preview — July 23 Maintenance</DialogTitle>
          </DialogHeader>
