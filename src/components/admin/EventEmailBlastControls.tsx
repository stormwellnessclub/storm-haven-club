...
const FN = "send-sound-bath-event-blast";

export function EventEmailBlastControls() {
  ...
  return (
    <div className="flex flex-wrap gap-2">
      ...
      <AlertDialog>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Send Sound Bath event email?</AlertDialogTitle>
            <AlertDialogDescription>
      ...
      <Dialog open={previewOpen} onOpenChange={setPreviewOpen}>
        <DialogContent className="max-w-3xl h-[85vh] flex flex-col p-0">
          <DialogHeader className="p-4 border-b">
            <DialogTitle>Email preview — Sound Bath event</DialogTitle>
          </DialogHeader>
