...
RETURNS TABLE(
  ...
  child_medications text,
  child_emergency_contact_name text,
  child_emergency_contact_phone text,
  child_relationship_to_child text,
  child_authorized_pickup_persons text,
  child_special_instructions text,
...
BEGIN
  ...
  SELECT
    ...
    kc.allergies AS child_allergies,
    kc.medical_conditions AS child_medical_conditions,
    kc.medications AS child_medications,
    ...
    kc.special_instructions AS child_special_instructions,
