...
REVOKE EXECUTE ON FUNCTION public.reconcile_and_generate_class_sessions(date, integer) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.reconcile_and_generate_class_sessions(date, integer) TO authenticated;
GRANT EXECUTE ON FUNCTION public.reconcile_and_generate_class_sessions(date, integer) TO service_role;