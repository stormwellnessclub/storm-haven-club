...
const departments: DepartmentSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Growth Report", url: "/admin/member-growth", icon: TrendingUp, roles: ['super_admin', 'admin', 'manager'] },
    ],
  },
  {
    label: 'Classes',
    ...
    items: [
      ...
      { title: "Instructor Pay", url: "/admin/instructor-pay", icon: DollarSign },
