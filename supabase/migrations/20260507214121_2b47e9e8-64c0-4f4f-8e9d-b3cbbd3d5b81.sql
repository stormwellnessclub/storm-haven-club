ALTER TABLE public.spa_therapists ADD COLUMN IF NOT EXISTS hourly_rate numeric(8,2) NOT NULL DEFAULT 26.00;

CREATE OR REPLACE FUNCTION public.get_therapist_payroll(
  _therapist_id uuid,
  _start_date date,
  _end_date date
)
...
GRANT EXECUTE ON FUNCTION public.get_therapist_payroll(uuid, date, date) TO authenticated;